...
public class QtScrollBarFactory extends com.trolltech.solutions.qtpropertybrowser.QtAbstractEditorFactoryBase
{
    ...
    public QtScrollBarFactory() {
        this((com.trolltech.qt.core.QObject)null);
    }
    public QtScrollBarFactory(com.trolltech.qt.core.QObject parent){
        super((QPrivateConstructor)null);
        __qt_QtScrollBarFactory_QObject(parent == null ? 0 : parent.nativeId());
    }

    native void __qt_QtScrollBarFactory_QObject(long parent);
    ...
    public static native QtScrollBarFactory fromNativePointer(QNativePointer nativePointer);

    protected QtScrollBarFactory(QPrivateConstructor p) { super(p); } 
}
