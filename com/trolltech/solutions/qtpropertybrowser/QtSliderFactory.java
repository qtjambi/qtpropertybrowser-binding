...
public class QtSliderFactory extends com.trolltech.solutions.qtpropertybrowser.QtAbstractEditorFactoryBase
{
    ...
    public QtSliderFactory() {
        this((com.trolltech.qt.core.QObject)null);
    }
    public QtSliderFactory(com.trolltech.qt.core.QObject parent){
        super((QPrivateConstructor)null);
        __qt_QtSliderFactory_QObject(parent == null ? 0 : parent.nativeId());
    }

    native void __qt_QtSliderFactory_QObject(long parent);
    ...
    public static native QtSliderFactory fromNativePointer(QNativePointer nativePointer);

    protected QtSliderFactory(QPrivateConstructor p) { super(p); } 
}
